...
class FirstWindow:
    ...
    def create_widgets(self):
        ...
        exit_button = Button(top_frame, text="Exit", command=self.root.destroy, height=2, width=12, bg="#FF69B4", font=("Arial", 12, "bold"), fg="white")  
...
class PlayWindow:
    def __init__(self, parent, difficulty,username):
        ...
        # Start button
        start = Button(self.play_window, text="Start", command=self.try_again, bg="#FF69B4", font=("Arial", 12, "bold"), fg="white")  
